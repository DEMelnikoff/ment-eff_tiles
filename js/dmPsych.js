      ...
      stimulus: () => {
        ...
        if (gameType == 'invStrk') {
          if (!tooSlow && streak < 20) {
            ...
            streak = 0;
            message = (feedbackType == "plus" && blockName !== "practice") ? tokens_bonus_html : (feedbackType == "minus" && blockName !== "practice") ? tokens_loss_html : tokens_html;
            message = (blockName !== "practice") ? message.replace("{strk-feedback}", `+${20 - finalStreak} Tokens`) : message.replace("{strk-feedback}", `Final Streak: ${finalStreak}`); 
  ...
  */
  ...
  obj.tileGame_howToPlay = function(gameType, gameName, color, hex, roundLength) {
      ...
      if (gameType == 'invStrk') {
          html = [
                `<div class='parent'>
                  <p>In the ${gameName}, your goal is to make your losing streaks as short as possible.</br>
  ...
  obj.tileGame_howToEarn = function(gameType, gameName_1, gameName_2, pM, color, hex, roundLength, round) {
      ...
      if (gameType == 'strk') {
        ...
        const fasterOrSlower = (pM < .75) ? "you'll have to respond faster than you did" : (pM > .75) ? "you won't have to respond as fast as you did" : "you'll have to respond just as fast as you did";
          ...
          html = [`<div class='parent' style='text-align: left'>
                    <p>The ${gameName_2} is identical to the ${gameName_1} with one exception:</p>
                    <p>You'll have <b>${speed} time</b> to respond to each tile.</p>
                    <p>Therefore, ${fasterOrSlower} during the ${gameName_1}.</p>
                  </div>`];
        };
